        ...
        <div className="chatpage">
            ...
            <div className="currentChat">
                ...
                {exampleChat.map(messages => (
                    ...
                    <li className='friendMessages' key={messages.id}>{messages.name} : {messages.message}</li> :
                    <li className='userMessages' key={messages.id}>{messages.name} : {messages.message}</li>  
                ))}
                </div>
                <form onSubmit={handleSubmit}>
                <label htmlFor="messageSubmit"></label>
                <input type="text" id="messageSubmit" name="message" onChange={handleChange} value={message.message || ''} />
                <button>Send</button>
                </form>
            </div>
        </div>
